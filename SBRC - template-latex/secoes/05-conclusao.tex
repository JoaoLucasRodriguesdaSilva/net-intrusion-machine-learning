...
Os resultados demonstraram que o modelo Random Forest apresentou o desempenho mais elevado com o conjunto de dados completo, alcançando resultados globais mais proximos de 1.0. Contudo, este modelo revelou-se extremamente sensível à ausência de informações críticas, como o parâmetro \textit{src\_bytes}, sofrendo uma degradação significativa na sua capacidade de identificar corretamente o tráfego normal.
...
Adicionalmente, o estudo revelou a sensibilidade do KNN ao parâmetro $K$ e a atributos específicos como o \textit{hot} e o \textit{diff\_srv\_rate}.
